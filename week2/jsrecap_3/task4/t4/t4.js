...
navigator.geolocation.getCurrentPosition((position) => {
  ...
  const restLong = position.coords.longitude;
  ...
  const sortedRestaurants = restaurants.sort((a, b) => {
    const distanceA = calculateDistance(restLong, restLat, a.location.coordinates[0], a.location.coordinates[1]);
    const distanceB = calculateDistance(restLong, restLat, b.location.coordinates[0], b.location.coordinates[1]);
